...
public class ConsumerDemoWithIncrementalCooperativeRebalance {
	private static final Logger logger = LoggerFactory.getLogger(ConsumerDemoWithIncrementalCooperativeRebalance.class.getSimpleName());

	public static void main(String[] args) {
		logger.info("ConsumerDemo");

		String bootstrapServer = "127.0.0.1:9092";
		String groupId = "consumer_demo_with_incremental_cooperative_rebalance";
		String topic = "topic1";
		...
		// kafkaConsumerConfigProperties.setProperty(ConsumerConfig.GROUP_INSTANCE_ID_CONFIG, "");
